...
module.exports = function () {
	...
	// Direct url link to a specific product by category
	_helpers.productscategoryUrl = function (productscategoryKey, options) {
		return ('/productscategory/' + productscategoryKey);
	};
